...
that we'll use is posted [here](https://pjakiela.github.io/ECON523/exercises/E5-fpedata-1981-to-2019.dta). We will use this data set to generate two-way fixed 
...
Before you begin, create a do file (with all the standard stuff at the top) that downloads [the data set](https://pjakiela.github.io/ECON523/exercises/E5-fpedata-1981-to-2019.dta).  Familiarize yourself with the data.  What years does it cover?   
...
Regress gross enrollment on `fpe` controlling for country and year fixed effects. Cluster your standard errors at the country level. What is the estimated impact of eliminating school fees on enrollment? 
...
Estimate a TWFE regression of primary school completion on fpe controlling for country and year fixed effects. Cluster your standard errors at the country level. Store your results (for example, using eststo).
