...
We'll review the different ways to estimate simple difference-in-differences models.  We'll also learn how to export results to excel using 
the `openxlsx` library..   
